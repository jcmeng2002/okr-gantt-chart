# -*- coding: utf-8 -*-
"""
AMS HRBP 实习生 nelsonmeng OKR 规划甘特图 V10
修正：广告业务学习报告、新人培训、计算广告学习 均延后一周至5/3
"""
...
# ============================================================
# ★ 任务数据 — V10: 广告业务/新人培训/计算广告均延后至5/3
# ============================================================
tasks_raw = [
    # ====== 阶段1 ======
    ...
    # ====== 阶段2 — 三项均延后至5/3 ======
    ("计算广告课程&教材学习", "04-12", "05-03", "#FF7A45",
     "◆ 广告业务学习报告(5/3)"),
    ("AMS新人培训课程", "04-12", "05-03", "#FF7A45", None),
    ("深入了解部门业务(WXG/TAD)\n(业务目标/核心干部)", "04-12", "05-10", "#FF7A45",
     "◆ 流量平台WXG\n   学习报告(5/10)"),
    ("了解工作内容/工作模式\n沟通习惯", "04-12", "05-10", "#FF7A45", None),

    # ====== 阶段3 ======
    ("设计职能演进思考报告", "04-26", "05-24", "#00B96B",
     "◆ 设计/AI产品经理\n   演进报告(5/24)"),
    ("AI产品经理演进思考报告", "04-26", "05-24", "#00B96B", None),
...
plt.tight_layout()
out = "/Users/mengjiachen/WorkBuddy/20260414135125/OKR_Gantt_Chart_v10.png"
...
check_dates = [
    ("公司课程学习 开始", "04-12"),
    ("公司课程学习 结束", "04-19"),
    ("计算广告学习 结束(延后一周)", "05-03"),
    ("AMS新人培训 结束(延后一周)", "05-03"),
    ("设计/AI产品演进 开始", "04-26"),
    ("设计/AI产品演进 结束", "05-24"),
    ("深入了解部门业务 结束", "05-10"),
]
